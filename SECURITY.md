...
<https://github.com/smeet666/mcp-lyricscom/security/advisories/new>. It reaches me
...
This server is a read-only client for lyrics.com. It holds no credentials, needs no
API key, opens no port, and writes nothing back to lyrics.com. That rules out most
of what a vulnerability report usually concerns.

What remains is worth reporting:

- **Anything that lets a caller reach a host other than lyrics.com.** The URLs are
...
Rate limiting by lyrics.com, or lyrics.com being down, is the upstream's business and
